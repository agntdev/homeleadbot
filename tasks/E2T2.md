# E2T2 — Group Listing Message with 'I'm interested' Button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HLB

Post formatted listing messages to selected groups with inline 'I'm interested' button. Handle callback to trigger buyer intake. Write spec to tests/specs/E2T2.json.
