# E1T2 — Group Claim Flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HLB

When bot is added to a group, auto-detect addition and prompt admins with 'Claim this group' inline button. Store group claims in PostgreSQL. Write spec to tests/specs/E1T2.json.
