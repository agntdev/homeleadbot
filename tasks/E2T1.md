# E2T1 — /create_listing Command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HLB

Implement /create_listing command in private chat. Collect listing title, description, price, details, and target groups. Write spec to tests/specs/E2T1.json.
