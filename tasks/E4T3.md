# E4T3 — 24-hour Follow-up for Uncontacted Leads

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HLB

Schedule 24-hour follow-up if lead not marked 'contacted'. Send buyer nudge message. Write spec to tests/specs/E4T3.json.
