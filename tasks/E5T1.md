# E5T1 — Database Schema & Connection

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HLB

Implement PostgreSQL tables: agents, groups, group_claims, listings, leads, lead_intake_items, lead_events, followup_jobs. Handle connection setup.
