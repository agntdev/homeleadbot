# E1T1 — /start Command & Agent Registration

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HLB

Create /start command that registers agent account (Telegram ID, display name). Add to main menu (T02). Write dialog spec to tests/specs/E1T1.json and append to tests/commands.json.
