# E4T1 — Hot Lead Notifications (A)

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HLB

For A leads: Post to agent's claimed group with intake + username. Send DM to agent with intake and action buttons ('Contact buyer', 'Mark contacted'). Write spec to tests/specs/E4T1.json.
