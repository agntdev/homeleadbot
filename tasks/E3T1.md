# E3T1 — Buyer Intake Conversation Flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HLB

Trigger intake flow when buyer taps 'I'm interested' or messages bot directly. Collect location, budget, bedrooms, timeline, pre-approval. Capture Telegram username. Write spec to tests/specs/E3T1.json.
