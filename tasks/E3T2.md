# E3T2 — Lead Scoring Logic

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HLB

Implement scoring rules: A (pre-approved + ≤30 days), B (either condition), C (others). Store scores in PostgreSQL. Write spec to tests/specs/E3T2.json.
